...
# Helper script to upload a player photo
# Usage: ./upload-player-photo.sh <image-file> <team-tag> <player-name>
# Example: ./upload-player-photo.sh ~/Downloads/faker.png T1 Faker

set -e

if [ "$#" -ne 3 ]; then
    echo "Usage: $0 <image-file> <team-tag> <player-name>"
    echo "Example: $0 ~/Downloads/faker.png T1 Faker"
    exit 1
fi
...
TARGET_FILE="src/main/resources/static/images/players/${TEAM_TAG_LOWER}-${PLAYER_NAME_LOWER}.png"
DB_PATH="/images/players/${TEAM_TAG_LOWER}-${PLAYER_NAME_LOWER}.png"

echo "================================================"
echo "  Player Photo Upload Helper"
echo "================================================"
echo ""
...
mkdir -p src/main/resources/static/images/players
...
/opt/homebrew/opt/postgresql@14/bin/psql \
  ...
  -c "UPDATE players SET image = '$DB_PATH' WHERE name = '$PLAYER_NAME' AND team_id = (SELECT id FROM teams WHERE tag = '$TEAM_TAG');"
...
echo "================================================"
echo ""
echo "Your player photo has been uploaded successfully!"
